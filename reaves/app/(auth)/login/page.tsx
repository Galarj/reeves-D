...
export default function LoginPage() {
  ...
  async function clientAction(formData: FormData) {
    ...
    try {
      ...
      setErrorText(e.message || 'An error occurred during sign in.');
    }
  }

  return (
    <main className="min-h-screen relative flex items-center justify-center bg-[#0a0a0f] overflow-hidden">
      {/* Background Effects */}
      ...
      {/* Floating Orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#552583]/10 rounded-full blur-[120px] animate-pulse pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#FDB927]/5 rounded-full blur-[150px] animate-pulse delay-1000 pointer-events-none" />
        ...
        <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/40 relative overflow-hidden animate-slideUp">
          ...
          <div className="mt-6 pt-6 border-t border-white/5 text-center">
            <p className="text-white/40 text-sm">
              ...
              <Link href="/signup" className="text-violet-400 hover:text-violet-300 font-medium transition-colors inline-flex items-center gap-1">
